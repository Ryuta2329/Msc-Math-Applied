...
# mod <- forecast::auto.arima(condmilk, stepwise=FALSE, approximation =FALSE)
# summary(mod)
Box.test(residuals(sarima_mod_1), type="Ljung-Box") 
```


```{r residuals-of-candidate}
