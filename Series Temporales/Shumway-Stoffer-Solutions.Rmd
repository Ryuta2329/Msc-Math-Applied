...
* Ejercicios del [capitulo 1](#capitulo-1). Caracteristicas de series temporales.
* Ejercicios del [capitulo 2](#capitulo-2). Analisis de datos exploratorio.
...
ggplot(df_jj[, c("index", "log_Earnings")], aes(x=index, y=log_Earnings)) +
