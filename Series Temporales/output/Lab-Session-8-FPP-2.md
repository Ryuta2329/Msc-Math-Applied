...
$$
r_t = -1,088136_{(0,1051348)} r_{t-1} -0,3500981_{(0,0962051)} r_{t-2} - r_{t-12} + 1,088136_{(0,1051348)} r_{t-13} + 0,3500981_{(0,0962051)} r_{t-14} + w_t + 0,0724975_{(0,1943947)} w_{t-1} -0,7274061_{0,168183} w_{t-2}
$$
